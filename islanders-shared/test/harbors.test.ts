...
describe('Rules when trading using harbors', () => {
  ...
  test('A player trading with a 3:1 harbor on a harbor increases the amount of the received resource by 1', () => {
    const w: World = {
      ...
      gameState: 'Started',
      map: [
        { coord: { x: -2, y: -2 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: -3, y: -1 }, diceRoll: 'None', type: 'ClayHarbor' },
        { coord: { x: -3, y: -2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -2, y: -1 }, diceRoll: 10, type: 'Wool' },
        { coord: { x: -3, y: 0 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -3, y: -1 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: -2, y: 0 }, diceRoll: 'None', type: 'Desert' },
        { coord: { x: -2, y: 2 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: -3, y: 1 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -3, y: 0 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -2, y: 1 }, diceRoll: 9, type: 'Wool' },
        { coord: { x: -1, y: -3 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -2, y: -2 }, diceRoll: 'None', type: 'ClayHarbor' },
        { coord: { x: -1, y: -2 }, diceRoll: 5, type: 'Stone' },
        { coord: { x: -1, y: -1 }, diceRoll: 6, type: 'Wool' },
        { coord: { x: -1, y: 0 }, diceRoll: 8, type: 'Wool' },
        { coord: { x: -1, y: 2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: -2, y: 2 }, diceRoll: 'None', type: 'WoodHarbor' },
        { coord: { x: -1, y: 1 }, diceRoll: 3, type: 'Wool' },
        { coord: { x: 0, y: -3 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: -1, y: -3 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 1, y: -3 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 0, y: -2 }, diceRoll: 'None', type: 'Desert' },
        { coord: { x: 0, y: -1 }, diceRoll: 10, type: 'Grain' },
        { coord: { x: 0, y: 0 }, diceRoll: 10, type: 'Grain' },
        { coord: { x: 0, y: 1 }, diceRoll: 6, type: 'Wood' },
        { coord: { x: 0, y: 3 }, diceRoll: 'None', type: 'StoneHarbor' },
        { coord: { x: -1, y: 2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 1, y: 2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 0, y: 2 }, diceRoll: 6, type: 'Clay' },
        { coord: { x: 1, y: -3 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 2, y: -2 }, diceRoll: 'None', type: 'GrainHarbor' },
        { coord: { x: 1, y: -2 }, diceRoll: 5, type: 'Grain' },
        { coord: { x: 1, y: -1 }, diceRoll: 4, type: 'Grain' },
        { coord: { x: 1, y: 0 }, diceRoll: 11, type: 'Wood' },
        { coord: { x: 1, y: 2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 2, y: 2 }, diceRoll: 'None', type: 'WoolHarbor' },
        { coord: { x: 1, y: 1 }, diceRoll: 8, type: 'Grain' },
        { coord: { x: 2, y: -2 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: 3, y: -1 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: 3, y: -2 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 2, y: -1 }, diceRoll: 3, type: 'Grain' },
        { coord: { x: 3, y: 0 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 3, y: -1 }, diceRoll: 'None', type: 'WoodHarbor' },
        { coord: { x: 2, y: 0 }, diceRoll: 6, type: 'Clay' },
        { coord: { x: 2, y: 2 }, diceRoll: 'None', type: 'ThreeToOneHarbor' },
        { coord: { x: 3, y: 1 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 3, y: 0 }, diceRoll: 'None', type: 'Ocean' },
        { coord: { x: 2, y: 1 }, diceRoll: 10, type: 'Stone' },
      ],
      pointsToWin: 10,
      gameStatistics: {
        turns: 2,
    ...
    const initialResult = success(w);
    const rule = rules.HarborTrade(
      new HarborTradeAction('P1', 'ThreeToOneHarbor', w.players[0].resources, wantedResources),
    );
    const applied = rule(initialResult);
    expect(applied).not.toHaveProperty('reason');
    applied.flatMap((w) => {
